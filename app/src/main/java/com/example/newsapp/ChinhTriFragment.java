...
public class ChinhTriFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chinh_tri, container, false);
        // Tìm kiếm RecyclerView trong layout
        recyclerView = view.findViewById(R.id.chinhtri_fragment);
